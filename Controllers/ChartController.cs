...
using SA51_CA_Project_Team10.Models.Bar;
...
namespace SA51_CA_Project_Team10.Controllers
{
    public class ChartController : Controller
    {
        ...
        {
            throw new NotImplementedException();// View(new ErrorViewModel { RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }
        ...
        public IActionResult Index()
        {
            ...
            data.Labels = new List<string>() { "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر" };

            LineDataset dataset = new LineDataset()
            {
                Label = "داده های سری اول",
                Data = new List<double?> { 65, 59, 80, 81, 56, 55, 40 },
                Fill = "false",
                Tension = 0.1,
                BackgroundColor = new List<ChartColor> { ChartColor.FromRgba(75, 192, 192, 0.4) },
            ...
            {
                Label = "داده های سری دوم",
                Data = new List<double?> { 65, 59, 80, 81, 56, 55, 40 },
                Fill = "false",
                Tension = 0.1,
                BackgroundColor = new List<ChartColor> { ChartColor.FromRgba(75, 50, 192, 0.4) },
                BorderColor = new List<ChartColor> { ChartColor.FromRgb(106, 20, 192) },
                BorderCapStyle = "butt",
                BorderDash = new List<int> { },
                BorderDashOffset = 0.0,
                BorderJoinStyle = "miter",
                PointBorderColor = new List<ChartColor> { ChartColor.FromRgb(10, 50, 25) },
                PointBackgroundColor = new List<ChartColor> { ChartColor.FromHexString("#ffffff") },
                PointBorderWidth = new List<int> { 1 },
                PointHoverRadius = new List<int> { 5 },
                PointHoverBackgroundColor = new List<ChartColor> { ChartColor.FromRgb(75, 192, 192) },
                ...
                PointHoverBorderWidth = new List<int> { 2 },
                PointRadius = new List<int> { 1 },
                PointHitRadius = new List<int> { 13 },
                SpanGaps = false
            };
           
            secondDataset.Data = new List<double?> { 100, 95, 85, 75, 60, 20, 12 };
