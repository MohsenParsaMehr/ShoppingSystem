...
function ratingStars(event) {
    ...
    if (stars === null || stars === '0') {
        ...
        stars = data.slice(-1);
        document.getElementById('rating' + productId).innerHTML = "امتیاز دهید:"
    } else {
        event.target.removeAttribute("style");
        document.getElementById('rating' + productId).innerHTML = "امتیاز شما:"
    }
...
function averageStars(event) {
    ...
    if (stars == null) { stars = 0; }
    document.getElementById('rating' + productId).innerHTML = "میانگین امتیاز:"
    highlightStars(elements, stars)
}
